...
public struct ManifestFileRequest: Codable {
    ...
    private var _vars: [String: ManifestVars]
    ...
    public init(
        ...
        self.body = body
        self._vars = vars ?? [:]  // Initialize with empty dict if nil
        self.extra = extra
    }

    private enum CodingKeys: String, CodingKey {
        case method, url, headers, body, vars, extra
    }

    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        method = try container.decode(Methods.self, forKey: .method)
        url = try container.decode(String.self, forKey: .url)
        headers = try container.decode([String: String].self, forKey: .headers)
        body = try container.decodeIfPresent(AnyCodable.self, forKey: .body)
        _vars = try container.decodeIfPresent([String: ManifestVars].self, forKey: .vars) ?? [:]
        extra = try container.decodeIfPresent(ManifestFileRequestExtra.self, forKey: .extra)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(_vars, forKey: .vars)  // Always encode vars
...
// Public because it's used in public API parameters
